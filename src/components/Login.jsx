...
const LoginForm = () => {
  ...
  return (
      ...
      <div className="bg-white   flex items-center justify-center w-[400px] h-[400px] p-5  rounded-xl shadow-lg  max-w-sm">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4  flex flex-col items-end justify-center">
          {/* فیلد یوزرنیم */}
          ...
          <div className="relative  flex items-end flex-col gap-3">
            ...
            <input
              type="text"
              {...register('fileNumber')}
              placeholder="شماره پرونده خود را وارد کنید"
          ...
          <button
            type="submit"
            className="w-full py-3 bg-lemon text-black rounded-lg font-semibold transition-all duration-300 "
          >
            ورود
          </button>
        </form>
