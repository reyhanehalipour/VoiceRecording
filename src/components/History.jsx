...
import { CloseCircle, DocumentText, Play, Refresh, VoiceCricle } from "iconsax-reactjs";
  ...
  return (
    <div className="p-6 bg-white bg-opacity-80 rounded-lg shadow-lg w-full max-w-md mx-auto space-y-5 border-2 border-blue-200 self-start">
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <h2 className="text-[15px] font-bold text-blue-700 text-center">صوت‌های قبلی</h2>
      ...
      <div className="flex items-center justify-between bg-blue-50 border border-blue-200 p-3 rounded-2xl shadow-sm hover:shadow-md transition-all">
        <div className="flex gap-2 items-center justify-center">
          ...
          <span className="text-sm text-blue-900 font-medium">2025-05-05</span>
        </div>

      </div>
     
          <DocumentText    onClick={() => handleShowText("این متن مربوط به این فایل صوتی هست. می‌تونه چند خط باشه.")}/>
          </div>
      {/* مودال */}
      {showModal && (
